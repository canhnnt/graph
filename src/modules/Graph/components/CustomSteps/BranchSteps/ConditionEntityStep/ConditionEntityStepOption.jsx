...
class ConditionEntityStepOption extends CommonStepOption {
  constructor(props) {
    super(props);
    this.stepType = 'ConditionEntity';
    this.state = {
...
export default withApollo(withTranslation()(ConditionEntityStepOption));
